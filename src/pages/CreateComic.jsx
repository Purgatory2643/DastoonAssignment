    ...
    return <div class="bg-zinc-800">
        ...
        <Modal
            ...
            <div class="bg-black">
                ...
                <form class="bg-black rounded px-8 pb-5 mb-0 mt-5">
                    <div class="mb-4">
                        <label class="block text-gray-700 text-md font-bold mb-2 text-white" for="username">
                            Prompt
                        </label>
